    ...
    projects: [
      {
        ...
        description: "Al Jamea Karen, Proposal sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence.\nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat.\nThe result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "STATUS Design Concept\nMasterplan concept for a religious center in Karen. The Capstone Karen masterplan concept draws from a series of design drivers all meant to reflect Capstone's foundational brief and various Biblical analogies.\nThe masterplan comprises the ministerial buildings, housing, and outdoor landscaped area. The design of the ministerial buildings consists of three pavilions – forming a triad of sorts. The pavilions are The Sanctuary, The Administrative Building and The Sunday School Building.\nThey are set in and surrounded by a lush and verdant landscape that rings their positions to create a sense of spiritual tranquil: the place of refuge in a weary land. The three pavilions share a powerful concentric courtyard that unites them – reflecting a three but one triad. It is a functional and powerful space that can serve for various events and functions.\nThe assembly of buildings are surrounded by two rings of pathways that will be intentionally treed and landscaped to create a comfortable meditative circuit. The aim is to define an interpretive experience that tells the ministry story as congregants and visitors use the space.\nThe very entrance and arrival experience is similarly envisioned to be a powerful one incorporating waterways, gardens, and appropriate drop-offs/ pickup points. At the forest edge of the campus are a few residential cottages that will sit within a quiet and forested neighborhood. Capstone Faith, Nairobi,",
      ...
      },
      {
        ...
        description: "STATUS Design Proposal\nDesign concept for the regeneration of Jomo Kenyatta Public Beach. Jomo Kenyatta Public Beach is located on Bamburi in Northern Mombasa, off the Mombasa-Malindi Highway and was reserved as a public beach for recreation in 1960 under Management of the Mombasa Municipal Council. It covers approximately 3.7 hectares.\nThe beach and surrounds are well utilised by the public, especially during holidays and over the weekends. However, services and facilities provided are not sufficient and should be further improved to enhance its utility.\nJomo Kenyatta Beach can be greatly improved with simple interventions. PLANNING's proposal is focused on creation of public spaces that are well designed, well defined, inclusive, and usable.\nAny interventions would be geared towards improving the user experience in what is already a highly utilized and popular beachfront. Access and circulation are improved and pedestrian movement is enhanced and prioritized.",
      ...
      },
      {
        ...
        description: "Mama Ngina Waterfront, 2019 sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description: "Diamond Trust Bank, Proposal sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "I&m Kigali sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Situated at the junction of Limuru Road & First Avenue Parklands, the proposed building will house the new headquarters of I&M Bank. Access will be off of First Avenue Parklands.\nThe ground floor and subsequent seven floors will cater to the bank, its sister insurance company and other tenants. The 4 levels of basement ensure ample parking for tenants and users of the building.\nThe U-Shaped floor plan helps the shading of the building, whilst allowing light and ventilation to filter through. This is further reinforced with the double volume sky gardens that feature on the south eastern façade facing Limuru Road and the City Park.\nThe sky gardens will be planted with shrubs and small trees help filter the air coming into the atrium. Additionally, a cascading water feature on the ground floor provides a source of cool air through the double skin on the façade, while also masking the sound pollution from Limuru Road.\nRain water harvesting, waste water treatment and solar power generation are being investigated as means to further increase the efficiency of the building.\nI&M Bank Headquarters, Limuru Road, Nairobi,",
      ...
      },
      {
        ...
        description: "PLANNING was approached by the client because of the way in which we had solved the challenges of Nairobi’s Lonrho House, a tower constructed over an existing three storey building on a restricted site. I&M Bank Ltd required a tower that would hold both office and retail space on their spatially restricted city center plot. \nDetailed cost and benefit studies were carried out at early design stages for several building options, keeping in mind existing buildings and busy roads on all sides and the need to build over the entire site. The design option agreed upon was a three level atrium opening onto Kenyatta Avenue and Muindi Mbingu Street. \nThis gave pedestrians access to podium shops, and offices in the tower above. The Atrium concept was successful in visually and functionally separating the retail from the offices, giving a visual impression of the tower rising from the ground (podium). \nThe Client felt that this option gave him the best commercial advantages. The office floors are designed so that natural cross ventilation is possible. \nStaircases, elevators and lavatories are on the westerly side of the building to shield offices from uncomfortable heat gains and glare from the afternoon sun. Limited building space meant a heat reflective glass cladding system would have to arrive on site in fully finished sections ready for assembly. \nAll floors are of a composite construction, where floor slabs were precast off site and lifted into position, thereby minimizing onsite concrete mixing and material storage. This area of the City is heavily polluted with noise and car exhaust fumes requiring mechanical air handling for the building. \n100% standby power provision and water storage in the basement ensures the building can survive temporary power and water supply failures. I&M Bank Tower, Nairobi CBD,",
      ...
      },
      {
        ...
        description: "An economically sustainable and environmentally friendly tower for the bank's headquarters in Upper Hill, Nairobi. The tower house offices a state of the art banking hall, and administrative offices and conference facilities for meetings, conventions and workshops.\nThe site presented three major challenges for a tower building: height limitations, very hard stone bed-rock and Nairobi's equatorial sun. A triangular-shaped tower block was arrived at. At 25 levels the triangular shaped plan gives all facades of the building prominence.\nEnvironmental design was key in defining the architecture, with all floors naturally lit and ventilated. Heat gain into the building is kept to a minimum whilst daylight to a maximum without the use of mechanical systems.\nExposed precast concrete waffle floor slabs provide for adequate thermal mass, absorbing internally generated heat during the day and cool air during the night. To reduce heat gain, extensive use of light-reflecting solar shading fins was adopted, coupled with louvered horizontal shading on the high light transmittance glazing.\nThree sky courts, each within three \"fire compartments\" were created to limit the spread of fire and smoke, allow air movement into the building and up through the atrium. The use of precast concrete floor slabs ensured speedier construction- a deliberate move to make up time after a lengthy excavation period.\nThe building provides 800sqm of office space per level, and 400 car parking spaces on five levels. Rainwater collection and treatment and water recycling reduce the already low running costs. The building is disabled-accessible and is serviced by seven high speed lifts, two of which are dedicated for fire-fighting and one VIP lift. The building was completed in 2015.",
      ...
      },
      {
        ...
        description: "Designed in 1989 to be Lonrho Africa’s Headquarters. The brief proved to be a challenge; to design a modern commercial high-rise that must show a minimum of 14% return on capital.\nTo be constructed over and through an existing, badly built, three floor building occupied by sitting tenants who could not be legally evicted, and whose day to day business had to continue.\nFour of Nairobi’s leading architectural practices were approached and all declined as each considered the brief to be impossible. PLANNING with the Structural Engineer I.B. Patel thought otherwise, and the Lonrho Africa Building now stands as evidence of that.\nPLANNING asked for 10 days to explore the options and think it through. This fully air-conditioned building ranks technically as the most complex development ever attempted in East Africa (possibly Africa).\nThe final design was completed on budget, with a 17% return on capital in the first years. Cars are parked above the existing building as basement parking was not an option. The car park floors are clear spans from Standard Street to Kaunda Street, with no columns between. Lonrho House, Nairobi CBD,",
      ...
      },
      {
        ...
        description: "PLANNING was commissioned to liaise with and take over from the international award winning architect, the late Henning Larsen, who was appointed by Industrial Promotion Services to produce the building’s Concept and its Outline Design.\nThe Client’s brief to Henning Larsen was for a building that would establish the visual and commercial presence of the Nation Media Group within the Central Business District of Nairobi.\nThe major challenges for Henning Larsen were the fast advancing technologies of the printing and graphics industries and the need (or otherwise) to accommodate these within this City Centre Building or elsewhere. (They were to be accommodated, later, in a building outside the City Centre).\nPLANNING’s tasks included those of rationalizing the structure to accommodate the design and working out how best to place the building’s services within the constraints of the twin cylindrical towers.\nThere were also problems to be resolved with the site, and with the Client’s requirements for adequate basement car parking. Construction of this building on its very constricted and busy City Centre site produced many challenges for the Consultants and for the Contractor. The building was however completed on budget and on time.",
      ...
      },
      {
        ...
        description: "Templeton House Office Building is a situated in the lush and green neighbourhood of Westlands in Nairobi, Kenya. This four-story office building is designed to be a harmonious blend of efficiency and mid-century modern aesthetics, reflecting the spirit of contemporary workspace design while integrating seamlessly into the natural beauty of the surroundings. \nThe primary design concept for this project is to create a sustainable and functional workspace that pays homage to the mid- century modern architectural style. This style emphasizes clean lines, open spaces, and a strong connection to nature. \nThe well-treed environment in Westlands serves as a key inspiration, with the building's design intending to embrace and enhance its natural surroundings. The Building is conceived to optimize workspace functionality. \nIt offers ample floor space while ensuring efficient circulation and use of natural light. The exterior of the building will feature sleek lines, minimalistic façades, and a neutral colour palette, characteristic of mid-century modern design. \nLarge, punched windows and select open terraces will connect the interior with the exterior, promoting a sense of openness and harmony with the environment. The ground level is dedicated to parking facilities, ensuring convenient and secure access for tenants and visitors. \nTempleton House, Westlands, Nairobi Kenya",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description: "Braeburn Schools, 1985 Onwards sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Mlc Prep School, Proposal sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Students will enjoy a new purpose built boarding house, designed specifically for College students. Students have single bedrooms in a series of linked cluster flats. \nThere are six students in each flat, with shared lounge, kitchen and bathroom facilities. Each flat has a patio or balcony with outstanding views over the Rift Valley. \nThe flats benefit from access to a shared communal common room and at the end of each group of clusters is connected to a resident house parent who encourages the development of independent study habits required for A level study and beyond. The cluster layout of the building ensures connectivity, security and plenty of natural day lighting, through the use of large windows. \nPLANNING was approached to design a Masterplan for the school's 5 year expansion plans that would see it provide world class facilities to bolster its reputation as one of the leading educational institutions within the East African region. St Andrew’s, Turi, Kenya EDUCATION PROJECT PROFILE P.02 The key buildings to be provided included a new senior girl's dormitory, new indoor sports centre, new sixth form accommodation as well as expansions and refurbishment of the existing performance hall, preparatory and senior school accommodation. \nIn addition, the school required additional staff houses which PLANNING designed as individual 2, 3 and 4 bedroom units as well as additional classrooms.",
    ...
    projects: [
      {
        ...
        description: "Blue Room Hotel sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Bweju Resort, Zanzibar sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Dutco Sand Island sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Elephant Rock, Loisaba sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "This spectacular site in Meru Park; the favorite haunt of world famous lioness Elsa – of the movie 'Born Free' – was the subject of exacting development conditions set by Kenya Wildlife Services:\n• None of the development to be visible from within the park.\n• Building materials to be sustainable wherever possible, with zero hardwood used.\n• All structures to be removable (after use) with minimal damage or disfigurement to the natural qualities of the site.\nLocating each of the 12 double bedrooms, the public rooms, kitchen, kitchen yard, manager's house and resident staff quarters out of the view of people within the park was a daunting challenge. The site is richly strewn with wonderful boulders.\nThere was no way one could design buildings first and then “place” them on site without compromising these magnificent stones, or compromising building layouts. A satisfactory alternative was agreed where PLANNING Architect Jim Archer worked on site with 3 inch paint brushes and white emulsion paint and a tape measure to set out each building – full size, on the ground. That way every single rock was respected and incorporated into the design.\nAt times the challenges of ensuring that the bedrooms and the public rooms all had views over the park, whilst remaining invisible from the park, seemed impossible. However, today these buildings stand to prove it could be done.\nThe suspension bridge was an inspired solution for crossing a deep gulley, and was built with engineering advice from the British Army. The small swimming pool was a magnificent design opportunity, set amongst massive natural boulders it has a vanishing horizon along the only edge that faces over and down towards game-rich savanna and wetlands.\nAll the bedrooms and balconies get the benefit of stunning Meru sunrises, accompanied by wonderful morning choruses from the rich and varied bird life.",
      ...
      },
      {
        ...
        description: "Located in Kitengela, Kajiado, on a 17 acre plot, this 1500 sqm development is for an exclusive lodge at the edge of the Nairobi National Park, overlooking Mbagathi River. The site slopes steeply towards the river with excellent views over the park and Nairobi city skyline.\nThe brief called for a restaurant, bar, recreational facilities, a kitchen and ten cottages on a steep, narrow site. Visitors' access is through the Nairobi National Park, taking advantage of the game drives over the Mbagathi River.\nPLANNING, with the guidance of Structural Engineer I.B. Patel designed this foot bridge that would ferry visitors from the edge of the park, over Mbagathi River and to the lodge. The main buildings comprise of the public rooms and 10 cottages (2 double cottages and 8 single cottages).\nThese are planned across the site's rocky and steep terrain. The swimming pool is positioned at the bottom of the cliff whilst the manager's house, service buildings and staff housing are situated on opposite ends at the top of the cliff.\nThe dominant use of gum poles for the public rooms, cottage roofs and columns was inspired by the indigenous yellow fever acacia and fig trees on site. Yellow quarry stone that was in abundance on site was gathered by the builders and used for an external finish. The lounge and dining spaces in the public rooms are entirely open to the elements, focusing on the charming views.\nRain is kept at bay with large overhangs from the low-pitched roof. Cottages blend into the surrounding which are dominated by the yellow fever acacia thorn trees and boulders. Emakoko Lodge, Kajiado, Kenya",
      ...
      },
      {
        ...
        description: "English Point Marina is a contemporary residential and hotel development on the Kenyan coast, located on a 4-acre beach front site across the creek from the historic Fort Jesus, with its spectacular view across the skyline of Mombasa Old Town. English Point Marina offers apartment living with the comfort, luxury and security of a hotel, and will be managed by the award winning team of the Pinewood Village Beach Resorts. \nThis development was conceptualized by Broadway Malyan, a UK based architectural firm, with PLANNING being brought on board to develop the design, and detailed design drawings, and supervise the construction. On-site facilities include a hotel, restaurant, spa & gym, serviced marina, water-sport centre and boardwalk with retail outlets. \nUnderground car parking, beneath and between the buildings. The residential component has four apartment blocks, each housing twelve 3-bedroom apartments, two penthouse apartments and one basement apartment, all on five floors. \nThe blocks are interlinked by what are known as lush-links. Green spaces are developed as roof-top gardens above the exposed roof areas of the basement. \nThe hotel block features 23 air-conditioned rooms with 3 suites and conference facilities.",
      ...
      },
      {
        ...
        description: "PLANNING designed the new Four Point Sheraton Hotel at its strategically located 1 acre site at the entrance to the Jomo Kenyatta International Airport, Nairobi, Kenya. The main objective of the design was to provide a convenient and iconic yet cost effective hospitality solution. \nPLANNING’s approach was to develop a highly efficient hotel that utilized the site to its full economic potential. This saw a design response suggesting 145 rooms for overnight guests, with the bulk of the back of house service placed at basement level. \nThis maximizes opportunities for a café-style lounge, sports bar, destination dining area and meeting spaces. It will keep a height of 5 floors. \nFurthermore, the spa and fitness facilities located at the top floor were set to ensure direct access to the roof terrace featuring a pool, lounge and bar with uninterrupted views to the national park. Coupled with the hotel shuttle service and the full size basement offering long term secure parking, this hotel invites passengers to enjoy the hotel facilities as a secondary airport waiting lounge. \nOverall, the massing and façade treatment aspires to achieve an elegant, contemporary and impressive presence both when approaching and leaving the airport.",
      ...
      },
      {
        ...
        description: "Futaisi Island, Dubai sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Investor's House, Loisaba sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Kalama Resource Centre sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Kilimanjaro Hotel, Dar-es-salaam sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Loisikitok Eco Lodge sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Maisara Resort, P1 sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Maisara Resort, P2 sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Mangapwani Resort, Zanzibar sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Mombasa Views Hotel sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Ol Suswa Resort sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Savannah Resort, Nairobi National Park sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "This NATIONAL AND INTERNATIONAL award winning project began in 1972, and continues today. Jim Archer first met with the clients His Highness the Aga Khan and Prince Amyn Aga Khan of Tourist Promotion Services in Kampala in the early 1960's. \nTheir first projects were Paraa and Kitchwamba Safari Lodges in Uganda, which were frustrated at the tender stages in 1971 by the anarchy and bloodshed in Uganda. In 1978, Jim Archer and Trevor Andrews regrouped in Nairobi where they were then appointed for major refurbishment and extensions to the Mombasa Serena Beach Hotel. \nThis Hotel has continued to be one of our client's flagship hotels, and PLANNING has been privileged to be consulted at all stages of its design and development. The existing bedrooms have been refurbished to make them twice their original size, and the Maisha spa has been designed and constructed. \nSerena Beach Hotel & Spa , Shanzu, ,",
      ...
      },
      {
        ...
        description: "This project emerged with a brief that stipulated a need to keep to ecological tourism standards and to ensure that there was a minimal impact on the ecosystem. Originally known as ‘Kitani Safari Lodge’, a renovation was conducted and ownership taken over by Severin. \nLocated in close proximity to Mzima Springs, the camp has stunning views of Mount Kilimanjaro and reflects the closeness of nature. The camp is of a luxury design, comprising of 21 standard tents, 4 junior suites and 2 executive suites designed for honeymooners. \nOther design features include a 30 person conference tent, a spa, a fitness room and a ying yang swimming pool. The camp has achieved the Eco Tourism of Kenya, Silver award. \nHOSPITALITY PROJECT PROFILE Severin Safari Camp, Tsavo West, Kenya",
      ...
      },
      {
        ...
        description: "Sultan Palace, located in Kikambala, north of Mombasa, has an excellent position on the Indian Ocean coast line. Azure sea, coral reef, soft white sand, cool breezes and palm trees come together to make this an ideal resort location. \nConsideration is given to sea views and cooling breezes to give maximum value and enjoyment to each of the residential units and hotel rooms. The style of the hotel and nearby residential units is a modern take on an Arabian palace, and the surrounding architecture throughout the rest of the resort is inspired by the local Swahili idiom. \nThe buildings incorporate cool, contemporary features to give guests and residents a modern yet authentically Kenyan experience.",
      ...
      },
      {
        ...
        description: "The client's brief was for the development of a Victorian themed golf resort hotel on an excellent site featuring an existing coffee farm with magnificent virgin forests in steep river valleys.\nHowever, the “Victorian” image was never clearly defined. Preceding the Internet era, visual research was not easy, especially being a Kenyan-based practice. Every detail had to be carefully hand drawn as there were no standardized details or specifications to fall back on.\nPLANNING proposed a 'Victorian Explorer' approach to the design of this 150 bed resort, picking up on the philosophy and magnificent quality of the Uganda Railways and Harbours Housing on Nairobi Hill (known today as Upper Hill), as far as both materiality and aesthetics were concerned.\nPLANNING led the consultants' team which included a Hotel Consultant and a Golf Course Architect to produce an exceptional 18-hole golf course sculpted through the forests, and along the valley's contours to fit perfectly into the rolling topography.\nEarly land-use studies of the existing coffee plantation were put to good use, not only to minimize expensive cut and fill but also to ensure that the resulting buildings were scaled to be below the beautiful indigenous treed skyline.\nToday the Windsor Hotel & Golf Resort is the only Golf Resort in Africa listed in the “Great Golf Resorts of the World”, and is one of a select few world-wide that have achieved this. It is also the major show-piece in the marketing publication “GOLF KENYA”, produced by the Kenya Tourism Board. Windsor Golf Hotel & Country Club, Kiambu,",
    ...
    projects: [
      {
        ...
        description: "Several possible sites were examined before this 6 hectare green field site was ultimately selected, largely on account of the relative ease for vehicle access and adequate space on site to accommodate the extensive effluent treatment plant that this development would require. Demands for water were far in excess of the local authorities’ ability to deliver the same. \nIt was therefore necessary to look to additional supplies. These were met by the very disciplined use of rainwater harvesting in tandem with a borehole and massive water storage tanks. \nThe disposal of the extensive and regular volumes of effluent was also a major design challenge, as was the clients requirements for a minimal columned structure. PLANNING worked very closely with the Structural Engineer Mangat I.B. \nPatel, to ensure the client was provided with as column free a structure as was economically possible. Administration accommodation is located at first floor level so that clear views over the facility floor areas are provided. \nCoastal Bottlers Mtwapa, Kilifi,",
      ...
      },
      {
        ...
        description: "STATUS Design Proposal PLANNING was privileged to be part of the team developing the masterplan for a proposed light industrial park for First Logistics Ltd at Athi River outside Nairobi. Its location in the fast growing and strategically located Athi River area, its convenience and advantageous proximity to the City of Nairobi and the major road routes to Tanzania and Mombasa, add to the unique quality of the area. \nIn the exercise, PLANNING endeavoured to not only create a place that works from a logistics point of view, but one of quality; where people will want to work, run their businesses from and connect their logistics to. Our key design and layout informants remained and were implemented; flexibility as key; coherence; the right balance between the route network, and open spaces. \nWe carefully coordinated strategies with the consulting transport planners, engineers, and physical planners on the project to ensure that transport planning and services engineering works as efficiently as possible. The project brief called for a mixed number of land uses with light industrial being primary supported by a business/commercial precinct and a transport administration precinct. \nThe road network was designed to start at a single customs-controlled access point at the south west of the site. The network then proceeded to loop around the site in a double-loaded road reserve and carriage hierarchy. \nLorry parking and screening was provided for at the entrance customs zone. MASTERPLANNING PROJECT PROFILE First Logistics Ltd, Athi River, Kenya",
      ...
      },
      {
        ...
        description: "Built on part of an 11 acre existing brown field site with a drop of 26m from the entrance to the end of the plot, the project involved the construction of a production hall, warehouse facilities, administration building, gate house and ancillary facilities for production of Pepsi Cola brand soft drinks, a first of its kind in the country. The production hall and the warehouse zone are built entirely with steel sections to allow for greater spans and are covered with a light weight roof. \nOne of the big challenges at the outset was the discovery of a disused quarry that had been used as a dump-site at the center of the site. PLANNING's solution was to create two different levels of flat earthworks separated by an embankment. \nThe larger production building and administration offices were built on the upper area of the site. The ancillary facilities such as the water tanks and effluent treatment plant were located in the smaller lower area. \nThis approach allowed for a cheaper structural option and provided room for future growth of the facility. The bottling plant was designed and built to strict environmental specifications based on elaborate services requirements, which were carefully coordinated at scheme design stage with participation from specialists. \nThis ensured that ducting, pipework and cabling were 'threaded' through the entire facility in an efficient and orderly manner to allow for safety, maintenance and ease of identification. The International Federation of Consulting Engineers (FIDIC) contract was used for this project.",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description: "STATUS Design Concept Concept Design for the streetscape adjacent the future GoDown Arts Centre in Nairobi Industrial Area. As part of the redevelopment of the GoDown Arts Centre, the first major arts centre in Kenya, we have been assigned to design the neighbouring streets Dundori and Dunga Road in the Nairobi Industrial Area. \nThe design aims to seamlessly integrate the cultural centre and the surrounding streets, creating flexible spaces, promote and prioritize non-vehicular movement, and increase the amount of green space. Streets are important components in the overall public space network. \nThe streets are a shared public resource, and must cater for a multitude of activities, uses, and users. With the new arts centre being developed, the surrounding streets must cater for changes in user behaviour and better accommodate public use, in particular walking and cycling. \nCore to the design is flexibility and multi-use. This to enable and accommodate a wider range of uses and activities during different hours of the day, or different days of the week. \nThe design gives priority to pedestrian movement with wide and unobstructed footpaths along the full length of the streets linked to raised pedestrian crossings. In addition, adequate space is allocated for vendors and kiosks, public transport stops, drop off zones and bicycle parking - activities which commonly encroaches on walkways and pushing pedestrians into the carriageway. \nRain gardens are introduced for storm water management, also adding greenery to the streetscape in addition to tree planting. The project is part of the global HerCity programme, an UN-Habitat initiative, which aims to actively engage girls and young women in the planning and design process. \nMore than 40 girls and young women have actively participated in the project, providing their unique input and insight of their experience of the streets as well as their suggestions on how to improve the spaces for the benefit of all. The GoDown Arts Centre Streetscape Design, Nairobi,",
      ...
      },
      {
        ...
        description: "The intention was to provide housing for the retirees of the British American Tobacco Ltd. The site is located off Mombasa Road on the outskirts of Nairobi and it has house types that range from 3-Bedroom town houses to 2-Bedroom single storey starter units since they were to cater for all grades of employees. \nThe site was planned with religious, social and small retail facilities. The entire area was landscaped with fruit trees in all gardens. \nThe development encompasses a total of 850 middle income houses in serviced and landscaped environment. Imara Daima Estate, Nairobi,",
      ...
      },
      {
        ...
        description: "STATUS Design Proposal A development of close to 1300 residential units in Kongowea, Mombasa County. The development is designed to create a symbiotic relationship with the nearby Kongowea Market and surrounding residential and commercial areas, with pedestrian traffic from the neighbourhood being allowed to pass through the development. \n7-meter-wide pedestrian thoroughfares flanked by commercial units link the site to the surrounding neighbourhood. Affordability, efficiency, and use of technology are major factors. \nThe Village is designed to encourage non-motorized transport, with parking areas being confined to the outer edges of the development. PLANNING has executed the master plan and part of the Concept Design Stage. \nMASTERPLANNING PROJECT PROFILE Johari Housing Development, Msambweni , Kenya",
      ...
      },
      {
        ...
        description: "STATUS Design Concept Preliminary masterplan concept for 250 acres of waterfront mixed-use development north of central Mogadishu. The vision for Keysaney Green is to develop a secure self-contained, modern, economically viable, mixed-use city district. \nIt will become an attractive part of the capital and encourage improvement of the area immediately to the south of Keysaney, being the old part of Mogadishu. The concept encompasses an integration of well-planned property development with environmental and social considerations, set above any other development of this kind in Somalia, if not East Africa. \nKeysaney Green will set a new standard of quality and be a benchmark for the region. Each of the properties within Keysaney Green will be set in a quality landscape setting. \nThis will predominantly be a car free environment, with well-developed and attractive public spaces. The integration and mix of activities and uses – residential, commercial, educational as well as social – is sought throughout the site. \nThe development will promote a lifestyle that combines work, leisure, and service, with housing. The mixed-use city district will appeal both to the local population and it's increasing wealth base, as well as an international clientele. \nKeysaney Green will be a considerable contribution to Mogadishu's urban growth, being driven by increased security and accelerating development. The area will provide much needed housing, education and health facilities, international hotel presence, restaurants, retail, and leisure facilities currently lacking. \nThe spatial layout of the area creates a distinctive block structure, with generous residential courtyards. Two disused stone quarries are proposed to be transformed into recreational space and parks, incorporating storm water features and be utilized as water reservoirs. \nAlong the coastline, a 2 km long public promenade offers unhindered views of the ocean.",
      ...
      },
      {
        ...
        description: "STATUS Design Proposal PLANNING participated in the urban and architectural design competition aimed at developing a strategic and transformational masterplan for the modernization and expansion of the existing Kimironko transport and market hub. Our proposal, developed in conjunction with ARUP, sought to transform this hub into a contemporary, mixed-use development in line with the goals of the Kigali Urban Master Plan. \nWe designed Kimironko Hub to promote a new city lifestyle, combining workspaces, service and leisure with housing and state of the art public transportation. The generous public realm, the backbone of the area, was designed to be an inclusive and attractive public space, to host a wide range of activities. \nEqual and generous opportunity to enjoy the urban space were considered in the public realm, giving like chances for boys, girls, young and old, to take part in the everyday urban life, and in the community. The masterplan proposed a structure where architectural and landscaping elements were combined in an urban context. \nKey areas within the masterplan are the Kimironko market, the Transport Hub, the Commercial Centre, Residential/Apartments zone and their linking public space, creating a compact, varied, and walkable city district. Kimironko Commercial Complex and Market, Kigali,",
      ...
      },
      {
        ...
        description: "STATUS Design Concept Design concept for a mixed-use commercial development in Kingongo, in the outskirts of Nyeri. The development consists of a mix or retail and leisure, in a setting aimed to create a destination attracting a wide range of customers and visitors. \nThe strategic location of the site, offering good access from major roads and generous views to Nyeri town to the south and Mount Kenya to the north-east, offers opportunities for a wide range of retailers and business. The masterplan provides a spatial layout aimed at optimizing the visitor's experience whilst locating business in a rational manner around a central pedestrian plaza from which businesses are directly accessed. \nThe central space is designed as a multi-use space to be flexible to accommodate a wide range of uses and events. Kingongo Commercial Development, Nyeri,",
      ...
      },
      {
        ...
        location: "Kenya",
        year: "2020",
        img: "/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/KISUMU CITY MASTERPLAN, Design Proposal 2020/IMAGES/KISUMU LAKEFRONT AERIAL VIEW_1.jpg",
        shortDescription: "Explore the intricate details of Kisumu City Masterplan, Design Proposal 2020, a premier masterplanning development in Kenya that pushes the boundaries of craft and form. Explore the full design journey below.",
        description: "STATUS Design Proposal Kisumu Lakefront Redevelopment. As part of Kisumu City redevelopment and modernization, we were assigned to design the strategic masterplan for the regeneration of the Kisumu Lakefront. \nThe design sought to transform this hub into a contemporary, mixed-use, sustainable waterfront development that will host a wide range of activities and attract a wide range of visitors from within Kisumu, as well as the larger regional area and international visitors. The masterplan proposed a spatial layout aimed at optimizing the visitor's experience whilst locating business in a rational manner around a central pedestrian plaza from which businesses are directly accessed. \nKey areas within the masterplan are the Lakefront promenade, the Transport Hub, the Commercial Centre, Residential/Apartments zone and their linking public space, creating a compact, varied, and walkable city district. Kisumu Waterfront Regeneration, Kisumu,",
        gallery: ["/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/KISUMU CITY MASTERPLAN, Design Proposal 2020/IMAGES/KISUMU LAKEFRONT AERIAL VIEW_1.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/KISUMU CITY MASTERPLAN, Design Proposal 2020/IMAGES/KISUMU LAKEFRONT AERIAL VIEW_2.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/KISUMU CITY MASTERPLAN, Design Proposal 2020/IMAGES/KISUMU LAKEFRONT BOULEVARD_1.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/KISUMU CITY MASTERPLAN, Design Proposal 2020/IMAGES/KISUMU LAKEFRONT BOULEVARD_2.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/KISUMU CITY MASTERPLAN, Design Proposal 2020/IMAGES/KISUMU LAKEFRONT PROMENADE_1.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/KISUMU CITY MASTERPLAN, Design Proposal 2020/IMAGES/KISUMU LAKEFRONT PROMENADE_2.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/KISUMU CITY MASTERPLAN, Design Proposal 2020/IMAGES/Kisumu Render.jpg"]
      },
      {
        slug: "nairobi-university-concept-design-proposal-2015",
        title: "Nairobi University Concept, Design Proposal 2015",
        type: "Masterplanning",
        location: "Kenya",
        year: "2015",
        img: "/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/NAIROBI UNIVERSITY CONCEPT, Design Proposal 2015/IMAGES/1.jpg",
        shortDescription: "Uncover the story behind Nairobi University Concept, Design Proposal 2015, a sophisticated masterplanning project in Kenya that balances community needs with architectural elegance. Explore the full design journey below.",
        description: "STATUS Design Concept This masterplan proposal was for the redevelopment of a large residential property into a dense, high-rise mixed-use development comprising of student hostels and a commercial center with retail and leisure components. \nThe design sought to maximize on the developmental potential of the strategically located site along State House Road, while at the same time providing for high-quality spaces. Non-motorized movement was prioritized with a well-defined and attractive public realm including pedestrian trails and cycling lanes. \nStudent accommodation was designed as compact and efficient units, but provided for high levels of comfort. The development also included social facilities such as a library, sports facilities and a community center. \nMASTERPLANNING PROJECT PROFILE University of Nairobi Student Hostels, Nairobi, Kenya",
        gallery: ["/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/NAIROBI UNIVERSITY CONCEPT, Design Proposal 2015/IMAGES/1.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/NAIROBI UNIVERSITY CONCEPT, Design Proposal 2015/IMAGES/2.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/NAIROBI UNIVERSITY CONCEPT, Design Proposal 2015/IMAGES/3.jpg"]
      },
      {
        slug: "st-andrew-s-turi-masterplan-2007",
        title: "St Andrew's Turi Masterplan, 2007",
        type: "Masterplanning",
        location: "Kenya",
        year: "2007",
        img: "/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/ST ANDREW'S TURI MASTERPLAN, 2007/IMAGES/1.jpg",
        shortDescription: "A journey through light and material: St Andrew's Turi Masterplan, 2007 in Kenya re-imagines what a masterplanning space can achieve. Explore the full design journey below.",
        description: "PLANNING was approached to design a Masterplan for the school’s 5 year expansion plans that would see it provide world class facilities to bolster its reputation as one of the leading educational institutions within the East African region. The key buildings to be provided included a new senior girl’s dormitory, new indoor sports centre, new sixth form accommodation as well as expansions and refurbishment of the existing performance hall, preparatory and senior school accommodation. \nIn addition, the school required additional staff houses which PLANNING designed as individual 2, 3 and 4 bedroom units as well as additional classrooms. MASTERPLANNING PROJECT PROFILE St Andrew's Turi, Molo, Kenya",
        gallery: ["/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/ST ANDREW'S TURI MASTERPLAN, 2007/IMAGES/1.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/ST ANDREW'S TURI MASTERPLAN, 2007/IMAGES/sports hall sections.jpg"]
      },
      {
        slug: "the-point-design-concept-2015",
        title: "The Point, Design Concept 2015",
        type: "Masterplanning",
        location: "Kenya",
        year: "2015",
        img: "/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/THE POINT, Design Concept 2015/IMAGES/1.jpg",
        shortDescription: "The Point, Design Concept 2015 stands as a testament to contextual architecture in Kenya. Discover how this masterplanning space harmonizes with its environment. Explore the full design journey below.",
        description: "STATUS Design Concept The vision for ‘The Point’ is to develop a contemporary, economically viable, high quality mixed-use town center in a strategic location. It will become a vibrant part of the region and encourage improvement of the area. \nEach of the properties within ‘The Point’ will be set in a high-quality landscape setting. The integration and mix of activities and uses – residential, commercial, leisure as well as social – is sought throughout the site. \nThe development will promote a lifestyle that combines work, leisure and service, with housing. The masterplan resulted in a mixed-use city district catering for a wide range of customers and visitors. \nMASTERPLANNING PROJECT PROFILE The Point Mixed-Use Development, Nairobi, Kenya",
        gallery: ["/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/THE POINT, Design Concept 2015/IMAGES/1.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/THE POINT, Design Concept 2015/IMAGES/2.jpg","/assets/images/2024/SECTOR PROFILES/MASTERPLANNING/THE POINT, Design Concept 2015/IMAGES/3.jpg"]
      },
    ]
  },
  {
    ...
    projects: [
      {
        slug: "abidjan-housing-proposal",
        title: "Abidjan Housing, Proposal",
        type: "Residential",
        location: "Kenya",
        year: "2024",
        img: "/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/ABIDJAN HOUSING, Proposal/IMAGES/1.jpg",
        shortDescription: "Discover the visionary design of Abidjan Housing, Proposal. Located in Kenya, this residential project sets a new standard for sustainable and aesthetic integrity. Explore the full design journey below.",
        description: "Abidjan Housing, Proposal sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
        gallery: ["/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/ABIDJAN HOUSING, Proposal/IMAGES/1.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/ABIDJAN HOUSING, Proposal/IMAGES/2.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/ABIDJAN HOUSING, Proposal/IMAGES/3.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/ABIDJAN HOUSING, Proposal/IMAGES/4.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/ABIDJAN HOUSING, Proposal/IMAGES/5.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/ABIDJAN HOUSING, Proposal/IMAGES/6.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/ABIDJAN HOUSING, Proposal/IMAGES/7.jpg"]
      },
      {
        slug: "bamburi-beach-apartments",
        title: "Bamburi Beach Apartments",
        type: "Residential",
        location: "Kenya",
        year: "2011",
        img: "/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/BAMBURI BEACH APARTMENTS/IMAGES/Bamburi-Apartments-1-min.jpg",
        shortDescription: "Experience the future of residential design with Bamburi Beach Apartments. A landmark project in Kenya that redefines spatial excellence. Explore the full design journey below.",
        description: "Bamburi Beach Apartments sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
        gallery: ["/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/BAMBURI BEACH APARTMENTS/IMAGES/Bamburi-Apartments-1-min.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/BAMBURI BEACH APARTMENTS/IMAGES/Bamburi-Apartments-min.jpg"]
      },
      {
        slug: "creston-apartments-2022",
        title: "Creston Apartments, 2022",
        type: "Residential",
        location: "Kenya",
        year: "2022",
        img: "/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/CRESTON APARTMENTS, 2022/IMAGES/Creston Render_2022.01.27_01.jpg",
        shortDescription: "Experience the future of residential design with Creston Apartments, 2022. A landmark project in Kenya that redefines spatial excellence. Explore the full design journey below.",
        description: "Creston Apartments, 2022 sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
        gallery: ["/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/CRESTON APARTMENTS, 2022/IMAGES/Creston Render_2022.01.27_01.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/CRESTON APARTMENTS, 2022/IMAGES/Creston Render_2022.01.27_02.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/CRESTON APARTMENTS, 2022/IMAGES/Creston Render_2022.01.27_03.jpg"]
      },
      {
        slug: "dhul-hulaifa-housing-proposal",
        title: "Dhul Hulaifa Housing, Proposal",
        type: "Residential",
        location: "Kenya",
        year: "2024",
        img: "/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/DHUL HULAIFA HOUSING, Proposal/IMAGES/1.jpg",
        shortDescription: "From its bold civic presence to its refined interiors, Dhul Hulaifa Housing, Proposal in Kenya is a masterclass in modern residential architecture. Explore the full design journey below.",
        description: "Dhul Hulaifa Housing, Proposal sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
        gallery: ["/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/DHUL HULAIFA HOUSING, Proposal/IMAGES/1.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/DHUL HULAIFA HOUSING, Proposal/IMAGES/2.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/DHUL HULAIFA HOUSING, Proposal/IMAGES/3.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/DHUL HULAIFA HOUSING, Proposal/IMAGES/4.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/DHUL HULAIFA HOUSING, Proposal/IMAGES/5.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/DHUL HULAIFA HOUSING, Proposal/IMAGES/6.jpg","/assets/images/2024/SECTOR PROFILES/RESIDENTIAL/DHUL HULAIFA HOUSING, Proposal/IMAGES/7.jpg"]
      },
      {
      ...
      },
      {
        ...
        description: "Pangani Housing sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Samara, Proposal sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description: "Rosslyn Riviera, 2017 sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
      ...
      },
      {
        ...
        description: "Sarit Centre, 2020 sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
    ...
    projects: [
      {
        ...
        description: "Vipingo Hospital sits within a careful balance of context, climate and craft. The brief called for a clear, restrained architectural language — one that defers to its surroundings while introducing a contemporary civic presence. \nDaylight, cross-ventilation and locally sourced materials guide the experience from threshold to interior, and the planning gives generous space to both gathering and quiet retreat. The result is a building that reads as inevitable: confident, low-key and built to age well.",
