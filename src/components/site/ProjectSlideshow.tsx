...
export function ProjectSlideshow({ images, title, intervalMs = 6000, className }: Props) {
    ...
    >
      ...
      <div className="absolute bottom-8 left-6 md:left-12 z-20 flex items-center gap-3">
        ...
        <button
          ...
          className="pk-glass-hover ml-2 h-12 px-6 rounded-full border border-white/40 backdrop-blur bg-white/10 text-white flex items-center gap-3 transition-all hover:bg-white/20"
        >
          <Maximize2 size={16} />
          <span className="text-[11px] uppercase tracking-[0.2em] font-light">View Full Gallery</span>
        </button>
      </div>
