...
>(
  (
    ...
    // We add a state so that we can use it in a data attribute.
      ...
      >
        ...
        <div
          className={cn(
            ...
            // Adjust the width of the actual sidebar component based on state.
            variant === "floating" || variant === "inset"
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-collapsible=offcanvas]_&]:cursor-pointer [[data-collapsible=offcanvas]_&]:after:left-full",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:opacity-100 md:opacity-0",
        className,
      )}
      {...props}
    />
